...
- 선택: 상자나 선, 숫자 상자를 클릭. 인스펙터에 활성화 버튼과 그 뉴런의 파라미터, 즉 bias와 들어오는 weight 노브가 나온다(나가는 weight는 다음 뉴런의 파라미터라 그 뉴런이나 선을 고르면 보인다. 2026-09-17에 나가는 weight를 뺐다). 선을 클릭하면 그 선만 골라진다
